...
function DetailOffer(props) {
  ...
  const {cookie, offer} = route.params;

  const confirmOffers = async () => {
    try {
      console.log(cookie)
      let response = await axios.get(`${url}/order/${offer.order_id}/confirm`, {
        headers: {
  ...
  const deliveryOffers = async () => {
    try {
      console.log(cookie)
      let response = await axios.post(`${url}/order/${offer.order_id}/delivery`, '',{
        headers: {
          Authorization: `Bearer ${cookie}`,
        },
      });
  ...
  const [missions, setMissions] = useState([
    {
      ...
      purview: offer.delivery_day,
    },
    {
      mission: 'Revisions',
      purview: offer.revison,
    },
    {
    ...
    <View
      ...
      <View
        ...
        <View
            ...
            <View
              ...
              <View
                ...
                <Text
                  ...
                  Expected delivery {offer.delivery_day}
                </Text>
                <View
                  style={{
                    flexDirection: 'row',
            ...
            <View
              ...
              <View
                ...
                <Text
                  ...
                  Your delivery date was updated to {offer.delivery_day}
                </Text>
                <View
                  style={{
                    marginTop: 10,
          ...
          {(offer.status_order === 'Offer' || offer.status_order === 'Completed') ? (
            <View style={{
              flexDirection: 'row',
              justifyContent: 'space-between',
            }}>
